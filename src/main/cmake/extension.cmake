...
function(set_copy_file_command_arguments variableName)
    if(${ARGC} GREATER_EQUAL 4 AND IS_DIRECTORY ${ARGV1} AND IS_DIRECTORY ${ARGV2})
        set(names)
    ...
    foreach(name ${names})
        if(NOT DEFINED foundFile)
            find_file(searchName NAMES ${name} PATHS ${ARGV1} NO_DEFAULT_PATH)
            if(EXISTS ${searchName} AND NOT IS_DIRECTORY ${searchName})
                set(foundFile ${searchName})
            endif()
        endif()
    endforeach()
