...
function(test_1)
    ...
    set(currentOutputDir "${CMAKE_CURRENT_LIST_DIR}/../../../build/${currentFileNameNoExt}/${CMAKE_CURRENT_FUNCTION}")
...
function(test_2)
    ...
    execute_process(
        COMMAND "${CMAKE_COMMAND}" "-P" "${scriptFile}" "--" "--no-escape-backslash" "sphinx"
                SOURCE_BASE_DIR "${currentOutputDir}"
                CONF_JSON_VARS "PROJECT_DIR=${currentOutputDir}"
                               "PROJECT_TITLE=${CMAKE_CURRENT_FUNCTION} designs"
                FILES "requirements/requirements.rst"
