...
function(test_1)
    ...
    vscode(
        ...
        LAUNCH_CONFIG_PRESENTATION_HIDDEN "false"
        LAUNCH_CONFIG_PRESENTATION_GROUP "my-group"
        LAUNCH_CONFIG_PRESENTATION_ORDER "1"
        LAUNCH_CONFIG_PRE_LAUNCH_TASK "Compile"
        LAUNCH_CONFIG_POST_DEBUG_TASK "Clean"
        LAUNCH_CONFIG_INTERNAL_CONSOLE_OPTIONS "openOnSessionStart"
        LAUNCH_CONFIG_DEBUG_SERVER "4711"
        LAUNCH_CONFIG_SERVER_READY_ACTION "debugWithEdge"
        LAUNCH_CONFIG_SERVER_READY_ACTION_PATTERN "listening on port ([0-9]+)"
        LAUNCH_CONFIG_SERVER_READY_ACTION_URI_FORMAT "http://localhost:%s"
        LAUNCH_CONFIG_SERVER_READY_ACTION_WEB_ROOT "\${workspaceFolder}"
        LAUNCH_CONFIG_SERVER_READY_ACTION_KILL_ON_SERVER_STOP "false"
        LAUNCH_CONFIG_TARGET "arm"
        LAUNCH_CONFIG_PROGRAM "\${workspaceFolder}/Debug/Exe/ewproj.out"
        LAUNCH_CONFIG_DRIVER "I-jet"
        LAUNCH_CONFIG_STOP_ON_SYMBOL "main"
        LAUNCH_CONFIG_WORKBENCH_PATH "\${command:iar-config.toolchain}"
        LAUNCH_CONFIG_PROJECT_PATH "\${command:iar-config.project-file}"
