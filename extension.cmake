...
macro(download file_name url)
    if(${ARGC} EQUAL 3)
        if(EXISTS "${DOWNLOADS_PREFIX}/${file_name}.md5")
            file(READ "${DOWNLOADS_PREFIX}/${file_name}.md5" "old.${file_name}.md5")
            if("${old.${file_name}.md5}" STREQUAL "${ARGV2}")
                unset("${old.${file_name}.md5}")
                message_status("exists md5 '${DOWNLOADS_PREFIX}/${file_name}.md5'")
            else()
                unset("${old.${file_name}.md5}")
                file(WRITE "${DOWNLOADS_PREFIX}/${file_name}.md5" "${ARGV2}")
                message_status("saved md5 to '${DOWNLOADS_PREFIX}/${file_name}.md5'")
            endif()
        else()
            file(WRITE "${DOWNLOADS_PREFIX}/${file_name}.md5" "${ARGV2}")
            message_status("saved md5 to '${DOWNLOADS_PREFIX}/${file_name}.md5'")
    ...
    if(NOT EXISTS "${DOWNLOADS_PREFIX}/${file_name}" AND NOT EXISTS "${DOWNLOADS_PREFIX}/${file_name}.md5")
        ...
        message_status("saved md5 '${url}' to '${DOWNLOADS_PREFIX}/${file_name}.md5'")
    elseif(NOT EXISTS "${DOWNLOADS_PREFIX}/${file_name}" AND EXISTS "${DOWNLOADS_PREFIX}/${file_name}.md5")
        file(DOWNLOAD "${url}" "${DOWNLOADS_PREFIX}/${file_name}")
        file(READ "${DOWNLOADS_PREFIX}/${file_name}.md5" "old.${file_name}.md5")
    ...
    elseif(EXISTS "${DOWNLOADS_PREFIX}/${file_name}" AND EXISTS "${DOWNLOADS_PREFIX}/${file_name}.md5")
        message_status("exists '${DOWNLOADS_PREFIX}/${file_name}' and '${DOWNLOADS_PREFIX}/${file_name}.md5'")
    else()
        message_send_error("not exists '${DOWNLOADS_PREFIX}/${file_name}.md5'")
        message_fatal_error("exists '${DOWNLOADS_PREFIX}/${file_name}'")
    endif()
endmacro()
